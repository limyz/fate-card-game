...
namespace WindowsGame1
{
    public class Panel : SivForm
    {
        ...
        public Panel(RectangleF rec, Screen parent)
            : base("image", parent, typeof(Image), rec)
        {
            this.texture = Game1.panelTexture;
            this.DrawOrder = 0.5f;
            this.Parent = parent;
            this.Rect = rec;
        }

        public Panel(string name, Texture2D texture, RectangleF rec
        ...
        public override void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            spriteBatch.DrawLayer(texture, Rect, Color.White);
        }
    }
}
